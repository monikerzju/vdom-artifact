...
test() {
  # warm up
  parallel :::  "ab -c 1 -n 60 https://localhost/"\
      "ab -c 1 -n 60 https://localhost/" > /dev/null 2>&1

  parallel :::  "ab -c 2 -n 60 https://localhost/"\
      "ab -c 2 -n 60 https://localhost/" > /dev/null 2>&1

  parallel :::  "ab -c 4 -n 60 https://localhost/"\
      "ab -c 4 -n 60 https://localhost/" > /dev/null 2>&1
        
  parallel :::  "ab -c 4 -n 1000 https://localhost/"\
      "ab -c 4 -n 1000 https://localhost/" > /dev/null 2>&1
          
  parallel :::  "ab -c 4 -n 60 https://localhost/" \
      "ab -c 4 -n 60 https://localhost/" \
      "ab -c 4 -n 60 https://localhost/" > /dev/null 2>&1
  ...
  # 4 threads
  parallel :::  "ab -c 1 -n 1000 https://localhost/"\
          "ab -c 1 -n 1000 https://localhost/" \
          "ab -c 1 -n 1000 https://localhost/" \
          "ab -c 1 -n 1000 https://localhost/" \
      > parallel-tmp 2>&1
  ...
  # 12 threads
  parallel :::  "ab -c 3 -n 1000 https://localhost/"\
          "ab -c 3 -n 1000 https://localhost/" \
          "ab -c 3 -n 1000 https://localhost/" \
          "ab -c 3 -n 1000 https://localhost/" \
      > parallel-tmp 2>&1
  ...
  # 24 threads
  parallel :::  "ab -c 5 -n 1000 https://localhost/"\
          "ab -c 5 -n 1000 https://localhost/" \
          "ab -c 5 -n 1000 https://localhost/" \
          "ab -c 5 -n 1000 https://localhost/" \
          "ab -c 4 -n 1000 https://localhost/" \
      > parallel-tmp 2>&1
