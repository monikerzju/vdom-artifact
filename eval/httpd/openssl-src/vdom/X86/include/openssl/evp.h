...
/*
 * Simple hash table functions for vkeys protection
 */

#include <stdbool.h>
#include <libvkeys.h>

#define VKEY_PAGE_NUM 127

extern __thread bool vkey_state[VKEY_PAGE_NUM];
extern __thread bool is_initialized_local;
extern __thread vkru_t *vkru;

extern bool vkey_map[VKEY_PAGE_NUM];
extern void * vkey_mem_root;
extern pthread_mutex_t vkey_lock;

/* thread related */
void mpt_unlock(EVP_PKEY *pkey);
void mpt_lock(EVP_PKEY *pkey);
